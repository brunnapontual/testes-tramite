...
public class SelecionarGrupodeDespesaTest {
  ...
  public void selecionarGrupodeDespesa() {
    ...
    // A opção selecionada some do dropdown?
    MatcherAssert.assertThat(driver.findElement(By.xpath("//div/div[2]/div/div")).getText(), is(not("31 - Pessoal e Encargos Sociais")));
    driver.findElement(By.cssSelector(".ng-touched .ng-arrow-wrapper")).click();
    // Com Impositiva Saúde selecionado
    driver.findElement(By.xpath("//input[@type=\'text\']")).click();
    driver.findElement(By.xpath("//span[contains(.,\'1. Impositiva - Saúde (Ações e Serviços Públicos de Saúde)\')]")).click();
    driver.findElement(By.xpath("//grupo-despesa-searchable-dropdown/div/ng-select/div/span")).click();
    driver.findElement(By.xpath("(//input[@type=\'text\'])[4]")).click();
    // Não aparece opção que nao era pra estar?
    MatcherAssert.assertThat(driver.findElement(By.xpath("//div[2]/div[2]/div")).getText(), is(not("32 - Juros e Encargos da Dívida")));
    // Botão X existe?
    {
